<div class="clearfix" style="padding-left: 2em; padding-right: 2em;">
  <div style="display: inline-table; float: left; text-align: center; vertical-align: middle;">
    <div>
    	<a href="https://nephrosite.polascin.net/" target="_top" title="NephroSite - Ľubomír Polaščín">
	   		...
	   		<img src="https://polascin.net/pix/elpi.jpg" alt="Ľubomír Polaščín - fotografia" style="border: 0; width: 500px; max-width: 100%;">
			</a>
		</div>
    <div>
  ...
  <div style="display: inline-table; float: right;">
    ...
    <!--<a href="https://nemocnica-bory.sk/ambulancia/nefrologicka/" target="_blank" title="Nefrologická ambulancia Nemocnice Bory">-->
    	<div style="background-color: mintcream; border-color: black; border-style: solid; border-width: thin; display: inline-table; padding: 0.5em;">
